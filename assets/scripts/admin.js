jQuery(document).ready(function ($) {
  ...
  if (viewportWidth < 1225) {
    ...
    $(".cd-dropdown").mouseenter(function () {
      $(this).addClass("dropdown-is-active");
    });
    $(".cd-dropdown").mouseleave(function () {
...
// Consumptions
var consumptions = {
  consumption1: ["House Special", 100, 88.0, 1, "", ""],
  consumption2: ["Fitness Pack", 50, 23.0, 1, "red", "list-red"],
...
// First consumption
var hold =
  '<div><a class="card consumption" data-animation=fade data-reveal-id=tax-combination><div class="cons-name color"><div class="added-message"><div class="message-holder"><p>Added</p><i class="icon-check-box-ln-1"></i></div></div><div class=title>Non-Taxed Special</div></div><div class=cons-info><div class=cost>$100.00</div><div class=v-points>100VP</div><div class=clear></div></div></a>';
// Loop through consumptions{} object
for (var cons in consumptions) {
  hold +=
    '<a class="consumption card ' +
    consumptions[cons][5] +
    '"><div class="cons-name color ' +
    consumptions[cons][4] +
    '"><div class="added-message"><div class="message-holder"><p>Added</p><i class="icon-check-box-ln-1"></i></div></div><div class=title>' +
    consumptions[cons][0] +
    "</div></div><div class=cons-info><div class=cost>$" +
    consumptions[cons][1] +
    "</div><div class=v-points>" +
    consumptions[cons][2] +
    "VP</div><div class=clear></div></div></a>";
}
// Close holder and add edit consumption
hold +=
  '<a class="card consumption edit-cons"href=addedit-consumption.html><div class=cons-name><div class=title>Add New Consumption <i class=icon-add-ln-3></i></div></div></a></div>';
...
$(".consumption").click(function () {
  ...
  var item =
    '<div class=item><div class="remove-item consRemove"><i class="icon-minus-ln-3"></i></div><div class=name><a href=item-detail.html><div class=title>' +
    name +
    "</div></a><p class=note>" +
    vpoints +
    "</p></div><div class=quantity>x1</div><div class=price>" +
    cost +
...
$(".contact").click(function () {
  ...
  var cell =
    '<div class="cell"><div class="cell-info"><div class="remove-item itemRemove"><i class="icon-minus-ln-3"></i></div><div class="checkout-cust-name">' +
    name +
...
$(".btn-cancel-addnew").click(function () {
  ...
  $(".cust-con-menu").show();
  $("#customer-tab, #allCustomers, .chosen-customer").removeClass(
    "full-height"
  );
  ...
  if (viewportWidth < 640) {
    setTimeout(function () {
      $("html,body").animate({
        scrollTop: $(".chosen-customer").offset().top - 50,
      });
    }, 500);
  }
});
